    ...
    return(
     <div>
      ...
      <div className='afternav1'>
        <h1 className='afternavtitle1'>Paul Alain Njankouo Ndam</h1>
        <p className='equipetitle1'>Equipe/ Paul Alain Njankouo Ndam</p>
        <button to =""className="Contactez-Nous-button1">Reserver </button>
      </div>
      <div className='teamcontent1'>
        <div className='firstteam'>
          <img src={AvocatIcon} alt="avocat" className="avocatt1"/>
          <div className='avocatinfo'>
            <p className='avocatpaul'>Paul Alain Njankouo Ndam</p>
            <p className='typeavct'>Avocat</p>
            <p className='paragaph-avocat'>Avocat au Barreau du Rwanda  d’origine camerounaise, avec un solide parcours académique et plus de dix ans d'expérience,
            excelle dans divers domaines du droit.des aptitudes dans différents domaines notamment les procédures contentieuses, le droit des affaires, le droit des transports, les procédures civiles et l'arbitrage.
            </p>
            <p className='paulinfo'>Age:  --- <br/>Experience: --- <br/>Specialité: Avocat</p>
            ...
            <img src={Iconfacebook} alt="paul facebook icon" className="pauliconfacebook"/>
            <img src={IconLinkedIn} alt="paul linkedin icon" className="pauliconlinkedin"/>
            </div>
            </div>
          <form className='contactmoi'>
            <h1 className='contactmoi-titre'>Contacter moi</h1>
            <TextField  type="name" label="Nom complet" variant="standard" className='Nom-complet'  />
            <TextField  type="name" label="Numéro telephone" variant="standard" className='Numéro-telephone'  />
            <TextField  type="name" label="Message" variant="standard" className='Message'  />
          ...
          <div className='thelinee'>
                <div className='leftLinee'>   
                </div>
                <h1 id="teamTitlee">Notre Equipe</h1>
                <div className='rightLinee'>  
                </div>
            </div>
